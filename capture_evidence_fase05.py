...
async def capture_fase_05():
    evidence_dir = r"C:\Users\felip\.gemini\antigravity\scratch\ana-elisa-site\docs\v3\evidence\fase-05"
    ...
    async with async_playwright() as p:
        ...
        await browser.close()
        print("SUCCESS: All Fase 5 full page screenshots generated with 0 console errors and 0px overflow.")

if __name__ == "__main__":
    asyncio.run(capture_fase_05())
