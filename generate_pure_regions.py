...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* SVG MAP STYLING - Recorte Puro por Macrorregião */
    .map-wrapper {
      position: relative;
      width: 100%;
      max-width: 530px;
    ...
    .map-region:hover, .map-region:focus {
      ...
      stroke: #FFFFFF;
      stroke-width: 2.5;
      filter: drop-shadow(0 0 12px rgba(222, 0, 33, 0.8));
      outline: none;
    }
    ...
    .map-region.active {
      ...
      stroke: #FFFFFF;
      stroke-width: 3;
      filter: drop-shadow(0 0 14px rgba(252, 189, 0, 0.6));
    }
...
<body>
  ...
  <header class="test-header">
    ...
    <p class="test-desc">Mapa territorial oficial com o recorte das 8 macrorregiões mineiras. Passe o mouse ou selecione para conhecer as prioridades populares de cada região e entrar no grupo de mobilização.</p>
  </header>

  <div class="map-container">
    
    <!-- MAPA SVG VETORIAL COM RECORTE PURO POR MACRORREGIÃO -->
    ...
    <div class="map-info-panel">
      ...
      <div class="info-card" id="infoCard">
        ...
        <p class="info-desc" id="infoDesc">
          Nossa região Centro-Oeste já está cansada com o desemprego, a falta de passe livre universitário e as passagens caras entre as cidades. É hora de quem vive aqui ter voz firme no Congresso.
        </p>
        <div class="info-pautas" id="infoPautas">
          <strong>Pautas Prioritárias da Região:</strong>
          <span>Empregabilidade e primeiro emprego para jovens, criação do Passe Livre Universitário intermunicipal (Divinópolis, Itaúna, Formiga, Samonte, Nova Serrana, Pará de Minas), ampliação dos serviços de saúde do SUS e defesa intransigente da classe trabalhadora pelo Fim da Escala 6x1.</span>
        </div>
...
print('SUCCESS: map-test.html updated with pure regional shapes and tailored political texts.')
